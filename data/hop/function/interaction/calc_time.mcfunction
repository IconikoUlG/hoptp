execute as @s[tag=hop.infinity] run return run execute unless score @s hop.time_cost matches 0.. run scoreboard players operation @s hop.time_cost = $base hop.time_cost
